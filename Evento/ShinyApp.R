...
ui <- fluidPage(
  ...
  navbarPage(title="",
             tabPanel("Home",
                      ...
                      tags$img(src="https://rstudio.com/wp-content/uploads/2014/04/shiny.png?width=200",height="50", width="50"),
                      ...
                      tags$img(src="https://i2.res.24o.it/images2010/Editrice/ILSOLE24ORE/NOVA24/2019/01/09/Nova24/ImmaginiWeb/Ritagli/MACHINE-kVT--835x437@IlSole24Ore-Web.jpg",height="400", width="800",style="display: block; margin-left: auto; margin-right: auto;"),
                      wellPanel(
             ...
             tabPanel("Cluster",
                      h5(),
                      h2("La seguente demo prevede un modello di clustering gerarchico"),
             ...
             tabPanel("Regressione Lineare",
                      ...
                      verbatimTextOutput("Out_Intercetta"),
                      ...
                      fluidRow(
                        ...
                        column(4,
                               wellPanel(
                                 selectInput("RES_VEN", label = h5("Seleziona i valori della variabile RES_VEN"),
                      ...
                      #                            "Cardiologia"=18),
                      #             selected = 0),
                      # verbatimTextOutput("BRA_Category"),
...
server <- function(input, output) {
  ...
  output$prev_abs <- renderPrint({abs(previsioni()[1])})
